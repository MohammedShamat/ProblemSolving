...
Date GetDateFromDay(short year, short days) {
	Date date;
...
int main() {
	...
	short daysTotal = TotalDaysFromBeginningYear(yearFromUser, monthFromUser, dayFromUser);
	Date ConvertToDate = GetDateFromDay(yearFromUser, daysTotal);
	cout << "\nNumber of days from the beginning of the year is " << daysTotal << endl;
	cout << "Date for [" << daysTotal << "] is :" << ConvertToDate.day << "/" << ConvertToDate.month << "/" << ConvertToDate.year;
